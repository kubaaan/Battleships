...
public class ShipDeployer {
    ...
    public static boolean deployShip(Map<String, Grid.Field> fields, battleships.game.grid.Ship ship, Map<String, Integer> shipsLocations){
    ...
    private static boolean checkIfDeploymentPossible(Map<String,Grid.Field> fields, battleships.game.grid.Ship ship) {
